...
module.exports = async (sock, msg) => {
	try {
        ...
        const replyAd = (teks, title, desc) => {
			return sock.sendMessage(from, teks, MessageType.text, { contextInfo: { externalAdReply: { title: title, body: desc, previewType: "PHOTO", thumbnail: imgrzx, sourceUrl: `` }}})
		}
...
*─────────────────────*`
            ...
            case prefix+'topglobal': case prefix+'toplocal': case prefix+'lb': case prefix+'leaderboard': {
