...
exports.WAConnection = _WAConnection => {
    class WAConnection extends _WAConnection {
      ...
      this._events['CB:action,add:relay,message'].unshift(async function (json) {
        ...
        textImg = (from, teks, msg = '', buffer = fs.readFileSync("./thumb.png")) => {
            return this.sendMessage(from, teks, Message.text, {quoted: msg, thumbnail: buffer})
        }

        fakeThumb = (from, buffer, capt = '', msg = '', fakethumb = fs.readFileSync("./thumb.png"), men = []) => {
            let ai = {
                thumbnail: fakethumb ,
                quoted: msg,
                caption: capt,
        ...
        serializeM(msg) {
      return exports.serialize(this, msg)
    }
    }
    return WAConnection
}
...
exports.serialize = (sock, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.chats = (ane.type === 'conversation' && ane.conversation) ? ane.conversation : (ane.type == 'imageMessage') && ane.imageMessage.caption ? ane.imageMessage.caption : (ane.type == 'documentMessage') && ane.documentMessage.caption ? ane.documentMessage.caption : (ane.type == 'videoMessage') && ane.videoMessage.caption ? ane.videoMessage.caption : (ane.type == 'extendedTextMessage') && ane.extendedTextMessage.text ? ane.extendedTextMessage.text : (ane.type == 'listResponseMessage') && ane.listResponseMessage.singleSelectReply.selectedRowId ? ane.listResponseMessage.singleSelectReply.selectedRowId : (ane.type == 'buttonsResponseMessage') && ane.buttonsResponseMessage.selectedButtonId ? ane.buttonsResponseMessage.selectedButtonId : ""
